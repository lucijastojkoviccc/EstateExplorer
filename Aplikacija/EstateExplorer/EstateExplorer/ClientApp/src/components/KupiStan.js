        ...
        if (broj == 2) {
            ...
            return (
                <div className="stanovi">
                    {<img src="https://www.hidrogradnjapromet.rs/images/2room.png" />}
            ...
            return (
                <div className="stanovi">
                    {<img src="https://www.hidrogradnjapromet.rs/images/3room.png" />}
            ...
            return (
                <div className="stanovi">
                    {<img src="https://www.hidrogradnjapromet.rs/images/4room.png" />}
            ...
            return (
                <div className="stanovi">
                    {<img src="https://www.hidrogradnjapromet.rs/images/5room.png" />}
            ...
            <div className="kupi-stan">
                ...
                <h3>Pretrazivac</h3>    
                    ...
                    <div className="filter-cena" >
                        <select onChange={(e) => setCena(e.target.value)}>
                            <option value="">Sve</option>
                            {Array.from(
                                new Set(zgrada.stanovi.map((z) => z.cenaKv))
                            ).map((c) => (
              ...
              <div className = "Stanovi">
                ...
                <div className="card-collection">
                        ...
                        {zgrada.stanovi.filter((stan) => stan.brojSoba.toString().includes(query) && stan.povrsina.toString().includes(povrsina) && stan.cenaKv.toString().includes(cena)).map(stan => (
                    <div key={stan.id}>
